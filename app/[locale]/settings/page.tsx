...
import { Bot, Save, RotateCcw, Palette, MessageSquare, Settings2, Globe } from 'lucide-react';
...
export default function SettingsPage() {
  ...
  if (!hasEditPermission) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <Settings2 size={48} className="text-gray-400 mx-auto mb-4" />
          <h2 className="text-xl font-bold text-gray-800 mb-2">权限不足</h2>
          <p className="text-gray-600">只有俱乐部所有者和管理员可以配置AI设置</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-6xl mx-auto py-8 px-4">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-bold text-gray-900">AI助手配置</h1>
          </div>
