...
// ==================== 视觉升级：扑克牌花色动态背景 ====================
const SpadeShape = () => (
  <div className="absolute top-0 -left-4 w-72 h-72 lg:w-96 lg:h-96 bg-gray-800/50 rounded-full mix-blend-screen filter blur-xl opacity-50 animate-blob">
...
const DiamondShape = () => (
  <div className="absolute bottom-0 -right-4 w-72 h-72 lg:w-96 lg:h-96 bg-rose-400/50 rounded-full mix-blend-screen filter blur-xl opacity-50 animate-blob animation-delay-4000">
